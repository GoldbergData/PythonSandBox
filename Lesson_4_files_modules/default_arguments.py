...
#
# Make the function easier to use by adding default arguments. By default the function should produce a bulleted
# list, and the default bullet character should be "-".
#
